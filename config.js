...
export const DEFAULT_CONFIG = {
  ...
  models: {
    ...
    "deepseek-v4.2-ultra": {
      ...
      reasoning_content: "我们需要回答用户。需要介绍自己是DeepSeek，能做什么。需要简洁清晰地用中文说明身份和能力。需要注意：我是DeepSeek，由深度求索公司创造。可以做什么：文本对话、问答、写作、翻译、编程、数据分析、文件处理（支持上传图像、txt、pdf、ppt、word、excel等），长上下文10M，支持语音输入（App），免费。需注意不声称有图像生成等能力，但可以读取上传文件中的文字信息。需要友好热情。回答不要太长，列出要点。",
      delay_ms: 0,
      max_tokens: 4096,
      temperature: 1.0,
      stream_chunk_size: 0,
